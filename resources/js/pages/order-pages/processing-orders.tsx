...
function StickyHeadTable({ rows }: StickyHeadTableProps) {
    ...
    const handleMarkComelete = (orderId: string) => {
        console.log('Mark as complete the order:', orderId);
                                                            ...
                                                            'action' ? (
                                                                <div className="flex justify-center gap-2">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="cursor-pointer rounded-lg p-2 text-[#6366F1] transition-colors hover:bg-[#6366F1] hover:text-white"
                                                                        title="Assign"
                                                                    >
                                                                        <UserPlus
                                                                            size={
