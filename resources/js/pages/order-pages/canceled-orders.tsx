...
function StickyHeadTable({ rows }: StickyHeadTableProps) {
    ...
    const handleOpenReasonModal = (orderId: string) => {
        setOrderId(orderId);
        setOpenReason(true);
    };

    const handleOnCloseReasonModal = () => {
        setOpenReason(false);
    };
    ...
    return (
        <>
            ...
            <ViewResonModal
                open={openReason}
                handleClose={handleOnCloseReasonModal}
                style={modalStyle}
                data={orderId}
            />
                                        ...
                                        return (
                                            ...
                                            >
                                                {columns.map((column) => {
                                                            ...
                                                            >
                                                                <div className="flex justify-center gap-2">
                                                                    <button
                                                                        ...
                                                                        className="cursor-pointer rounded-lg p-2 text-yellow-600 transition-colors hover:bg-yellow-600 hover:text-white"
                                                                        title="Reason"
                                                                    >
                                                                        <Info
                                                                            size={
                                                    ...
                                                    const value =
                                                        row[
                                                            column.id as keyof TableAttribProps
                                                        ];
                                                    return (
                                                        <TableCell
                                                            key={column.id}
